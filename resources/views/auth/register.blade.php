    ...
    <div class="max-w-md mx-auto mt-10 px-6">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
                ...
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="role" value="mahasiswa" class="accent-black" {{ old('role', 'mahasiswa') == 'mahasiswa' ? 'checked' : '' }}>
                            <span class="text-sm text-gray-600">Pencari Kost</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="role" value="pemilik" class="accent-black" {{ old('role') == 'pemilik' ? 'checked' : '' }}>
            ...
            <div class="mt-6 text-center text-sm text-gray-500">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-black font-medium hover:underline">Masuk</a>
            </div>
        </div>
    </div>
@endsection